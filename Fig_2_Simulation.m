...
for iter=1:1000,
	...
	for i = 1:steps
        ...
        % Update Population activity [Binary Neuron Dyamics - Eqn (1)]
        %---------------------------------------------------
    ...
    set(s1,'Units','normalized', 'position', [0.1 0.6 0.3 0.3]);
set(s2,'Units','normalized', 'position', [0.6 0.6 0.3 0.3]);
    set(s3,'Units','normalized', 'position', [0.1 0.1 0.3 0.3]);
set(s4,'Units','normalized', 'position', [0.6 0.1 0.3 0.3]);
	drawnow; 
